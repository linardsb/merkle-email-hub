...
- **Phase 25** — Platform Ecosystem & Advanced Integrations (15 subtasks: 25.1 Plugin architecture DONE, 25.2 Plugin sandbox & lifecycle DONE, 25.3 Tolgee TMS DONE, 25.4 Tolgee frontend DONE, 25.5 Kestra workflows DONE, 25.6 Penpot design pipeline DONE, 25.7 Typst report generator DONE, 25.8 Ecosystem dashboard DONE, 25.10 Template learning pipeline DONE, 25.11 Automatic skill extraction DONE, 25.13 Deliverability intelligence DONE; remaining: 25.9 tests & docs, 25.12 template-to-eval pipeline, 25.14 multi-variant campaign assembly, 25.15 tests for 25.10-25.14)

**Completed phases 0–24, 25.1–25.8, 25.10–25.11, 25.13** — see `docs/TODO-completed.md` for details (use jDocMunch `search_sections`).
**Next:** Phase 25.9 (Tests & Documentation).
