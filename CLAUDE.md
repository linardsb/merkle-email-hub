...
See `TODO.md` for details. Completed: phases 0-10, tasks 11.1-11.21, 11.22.1-11.22.6.

**Active:** 11.22 Template-first hybrid architecture (subtasks 1-6 done; 7-9 remaining, plan: `.agents/plans/11.22-deterministic-agent-architecture.md`). Next: 11.22.7 (novel layout fallback). Then 11.22.8-11.22.9, 11.23-11.24, Phase 12 (Figma import), Phase 13 (ESP sync).
