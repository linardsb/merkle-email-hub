...
- **Phase 26** — Email Build Pipeline Performance & CSS Optimization (5 subtasks — 26.1 DONE: optimize_css pre-build pipeline; 26.2-26.5 remaining: per-build CSS audit, template precompilation, consolidated sidecar pipeline, tests)
