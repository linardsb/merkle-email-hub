...
- **Phase 27** — Email Client Rendering Fidelity & Pre-Send Testing (4/6 done — 27.1 expand emulators DONE, 27.2 rendering confidence scoring DONE, 27.4 emulator calibration loop DONE, 27.5 headless email sandbox DONE; 27.3 frontend DONE (gate panel, hooks, wired into export + push-to-ESP dialogs); remaining: 27.3 backend gate service, frontend rendering dashboard & tests)
