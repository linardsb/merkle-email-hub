...
- **Phase 24** — Real-Time Collaboration & Visual Builder (24.1 WebSocket infra DONE, 24.2 Yjs CRDT engine DONE, 24.3 Collaborative cursor & presence DONE, 24.4 Visual builder canvas & palette DONE, 24.5 Property panels & section configuration DONE, 24.6 Builder ↔ code bidirectional sync DONE, 24.8 Tests & docs DONE, 24.9 AI-powered HTML import DONE; remaining: 24.7 frontend integration)
- **Phase 25** — Platform Ecosystem & Advanced Integrations (15 subtasks: plugin manifest & registry, plugin sandbox & lifecycle, Tolgee TMS, Tolgee frontend, Kestra workflows, Penpot design pipeline, Typst report generator, ecosystem dashboard, tests & docs, template learning pipeline, automatic skill extraction, template-to-eval pipeline, deliverability intelligence, multi-variant campaign assembly, tests for 25.10-25.14)

**Completed phases 11.25–24.9** — see `docs/TODO-completed.md` for details (use jDocMunch `search_sections`).
