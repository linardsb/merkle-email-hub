...
**Remaining:** Human label calibration (540 rows for TPR/TNR). Phase 9.4, 9.6–9.7 graph-driven intelligence features.
...
- **Testing:** Backend pytest (822 tests, incl. 19 BOLA security tests + 23 error sanitizer tests + 75 eval tooling tests + 20 rate limiting/resource control tests + 42 Phase 6.4 tests + 21 Phase 7 handoff/confidence/component tests + 19 memory module tests + 80 agent tests + 8 graph knowledge tests + 19 outcome logging tests + 51 ontology tests + 15 audience context tests + 51 ontology sync tests + 20 component QA tests + 14 onboarding subgraph tests + 17 skill A/B tests); Frontend Vitest + React Testing Library (`make test-fe`)
