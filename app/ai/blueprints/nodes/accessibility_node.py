...
class AccessibilityNode:
    ...
    async def execute(self, context: NodeContext) -> NodeResult:
        ...
        try:
            ...
            logger.error("blueprint.accessibility_node.no_html_in_response", error=str(exc))
            return NodeResult(status="failed", error=f"Accessibility did not produce HTML: {exc}")
