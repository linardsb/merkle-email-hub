...
SPAM_TRIGGERS = {
    "urgency": [
        "act now", "limited time", "urgent", "expires today", "order now",
        "don't hesitate", "final call", "immediately", "this won't last",
        "while supplies last", "last chance", "hurry", "before it's too late",
    ],
    "financial": [
        "make $", "earn cash", "easy income", "instant earnings",
        "double your wealth", "financial freedom", "save big money",
        "100% free", "free money", "no cost", "no obligation",
    ],
    "clickbait": [
        "click here", "click below", "amazing deal", "can't miss",
        "you will not believe", "incredible deal", "once in a lifetime",
        "congratulations", "you've been selected", "winner",
    ],
    "pressure": [
        "buy now", "call now", "apply now", "sign up free",
        "limited offer", "exclusive deal", "special promotion",
        "risk-free", "guaranteed", "no catch", "100% guaranteed",
    ],
}
