"""Dark mode agent artifact adapter."""
...
class DarkModeArtifactAdapter:
    """Reads HTML, produces transformed HTML with dark mode support."""
    ...
    def adapt_outputs(self, response: object, store: ArtifactStore) -> None:
        ...
        store.put(
            "html",
            HtmlArtifact(name="html", produced_by="dark_mode", produced_at=now, html=html),
        )


register_adapter(DarkModeArtifactAdapter())
