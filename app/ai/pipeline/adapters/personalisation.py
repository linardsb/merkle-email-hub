"""Personalisation agent artifact adapter."""
...
class PersonalisationArtifactAdapter:
    """Reads HTML, produces HTML with personalisation merge tags."""
    ...
    def adapt_outputs(self, response: object, store: ArtifactStore) -> None:
        ...
        store.put(
            "html",
            HtmlArtifact(name="html", produced_by="personalisation", produced_at=now, html=html),
        )


register_adapter(PersonalisationArtifactAdapter())
