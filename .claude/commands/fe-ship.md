...
Run `/fe-validate` (all 7 levels: lint+format, TypeScript, build, design system, security, unit tests, CI parity gates). If everything passes cleanly, proceed. If there are failures, fix them before moving on.
