...
export const SPRING_SALE_HERO_HTML = wrapEmail(
  ...
  `<!-- Header -->
              ...
              <table role="presentation" class="header-bg" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff;">
                <tr>
                  <td style="padding: 20px 24px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td style="width: 150px;"><img src="https://placehold.co/150x40/E4002B/white?text=APEX" alt="Apex Retail" width="150" height="40" style="display:block;border:0;" /></td>
          ...
          <tr>
            <td>
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-image:url('https://placehold.co/600x300/4CAF50/white?text=Spring+Collection');background-size:cover;background-position:center;">
                <tr>
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td width="50%" style="padding:8px;vertical-align:top;">
                          <img src="https://placehold.co/280x200/E8F5E9/333?text=Linen+Blazer" alt="Spring Linen Blazer" width="280" style="display:block;width:100%;height:auto;border:0;border-radius:4px;" />
                        ...
                        <td width="50%" style="padding:8px;vertical-align:top;">
                          <img src="https://placehold.co/280x200/FFF3E0/333?text=Cotton+Dress" alt="Floral Cotton Dress" width="280" style="display:block;width:100%;height:auto;border:0;border-radius:4px;" />
  ...
  `          <tr><td>
              <table role="presentation" class="header-bg" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#ffffff;">
                <tr><td style="padding:20px 24px;">
                  <img src="https://placehold.co/150x40/E4002B/white?text=APEX" alt="Apex Retail" width="150" height="40" style="display:block;border:0;" />
                </td></tr>
              </table>
          </td></tr>
          <tr><td>
...
export const VALENTINES_PROMO_HTML = wrapEmail(
  ...
  `          <tr><td>
          ...
          <tr><td>
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-image:url('https://placehold.co/600x300/FFE4E1/E4002B?text=%E2%9D%A4+Valentine%27s');background-size:cover;background-position:center;">
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td width="33%" style="padding:8px;text-align:center;vertical-align:top;">
                        <img src="https://placehold.co/180x180/FFF0F0/E4002B?text=Under+%C2%A325" alt="Under 25 pounds" width="180" style="display:block;width:100%;height:auto;border:0;border-radius:50%;" />
                        <p style="margin:8px 0 0;font-family:Arial,sans-serif;font-size:14px;font-weight:bold;color:#E4002B;">Under &pound;25</p>
                      </td>
                      <td width="33%" style="padding:8px;text-align:center;vertical-align:top;">
                        <img src="https://placehold.co/180x180/FFF0F0/E4002B?text=Under+%C2%A350" alt="Under 50 pounds" width="180" style="display:block;width:100%;height:auto;border:0;border-radius:50%;" />
                        <p style="margin:8px 0 0;font-family:Arial,sans-serif;font-size:14px;font-weight:bold;color:#E4002B;">Under &pound;50</p>
                      </td>
                      <td width="33%" style="padding:8px;text-align:center;vertical-align:top;">
                        <img src="https://placehold.co/180x180/FFF0F0/E4002B?text=Luxury" alt="Luxury gifts" width="180" style="display:block;width:100%;height:auto;border:0;border-radius:50%;" />
              ...
              <table role="presentation" class="content-bg" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#fff;">
                ...
                <tr><td style="padding:0 24px 32px;">
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td width="50%" style="padding:8px;vertical-align:top;">
                        <img src="https://placehold.co/270x200/FFF0F0/333?text=For+Her" alt="Gifts for Her" width="270" style="display:block;width:100%;height:auto;border:0;border-radius:8px;" />
                      ...
                      <td width="50%" style="padding:8px;vertical-align:top;">
                        <img src="https://placehold.co/270x200/F0F0FF/333?text=For+Him" alt="Gifts for Him" width="270" style="display:block;width:100%;height:auto;border:0;border-radius:8px;" />
  ...
  `          <tr><td>
              <table role="presentation" class="header-bg" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#fff;">
                <tr><td style="padding:20px 24px;text-align:center;">
                  <img src="https://placehold.co/150x40/E4002B/white?text=APEX" alt="Apex Retail" width="150" height="40" style="display:block;margin:0 auto;border:0;" />
                </td></tr>
              </table>
          </td></tr>
          <tr><td>
              ...
              <table role="presentation" class="content-bg" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#fff;">
                <tr><td style="padding:32px 24px;">
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td width="50%" style="padding:8px;vertical-align:top;">
                        <img src="https://placehold.co/270x200/E8F5E9/333?text=Bestseller+1" alt="Product 1" width="270" style="display:block;width:100%;height:auto;border:0;border-radius:4px;" />
                      ...
                      <td width="50%" style="padding:8px;vertical-align:top;">
                        <img src="https://placehold.co/270x200/E3F2FD/333?text=Bestseller+2" alt="Product 2" width="270" style="display:block;width:100%;height:auto;border:0;border-radius:4px;" />
...
export const SUMMER_PREVIEW_HTML = wrapEmail(
  ...
  `          <tr><td>
          ...
          <tr><td>
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-image:url('https://placehold.co/600x350/87CEEB/fff?text=Summer+2026');background-size:cover;background-position:center;">
