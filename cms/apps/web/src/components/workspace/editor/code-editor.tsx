...
export const CodeEditor = forwardRef<CodeEditorHandle, CodeEditorProps>(function CodeEditor({
  ...
  const debouncedLint = useCallback((editor: monacoEditor.IStandaloneCodeEditor, monaco: Monaco) => {
  ...
  const handleEditorDidMount: OnMount = useCallback((editor, monaco) => {
    ...
    if (collaborative) {
      ...
      try {
        ...
        console.warn("[CodeEditor] Collaborative binding failed, falling back to solo mode:", err);
      }
    }
